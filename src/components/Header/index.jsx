...
const Component = () => {
  ...
  return (
    <header>
      ...
      >
        {!isOpen ? (
          <img src={openbtn} alt="開く" style={{ width: "20px" }} />
        ) : null}
      </button>
      {isOpen ? (
        <div className={style.sp_menu}>
          ...
          >
            <img src={closebtn} alt="開く" style={{ width: "20px" }} />
          </button>
          <nav className={style.sp_nav}>
            <ul className={style.sp_nav_list}>
              <li className={style.sp_nav_item}>
                <a href="#a01" onClick={() => setIsOpen(false)}>
                  ABOUT
                </a>
              </li>
              <li className={style.sp_nav_item}>
                <a href="#a02" onClick={() => setIsOpen(false)}>
                  HISTORY
                </a>
              </li>
              <li className={style.sp_nav_item}>
                <a href="#a03" onClick={() => setIsOpen(false)}>
                  SKILL
                </a>
              </li>
              <li className={style.sp_nav_item}>
                <a href="#a04" onClick={() => setIsOpen(false)}>
                  WORK
                </a>
              </li>
            </ul>
